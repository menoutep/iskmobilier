"""
Django settings for iskmobilier project.
...
SECRET_KEY = 'django-insecure-e91a%+lxj$#400nzn)49ar2*x7pqm*5)b6r*fw-_3_5yjh1s$7'
...
WSGI_APPLICATION = 'iskmobilier.wsgi.application'
